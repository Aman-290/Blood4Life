...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $password = isset($_POST["password"]) ? htmlspecialchars($_POST["password"]) : ""; // No need to htmlspecialchars for the password
  ...
  $stmt = $conn->prepare("INSERT INTO patient (name, email, phone, password, bloodgroup, gender, birthdate, `weight`, state, zipcode, district, area, landmark) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  if (!$stmt) {
      ...
      <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png'); margin: 0%;" aria-label="hero">
        ...
        <div class="container">
          <div class="form-container">
            <div class="form-title">Patient Register</div>
            ...
            <div class="form-title">Already Registered? <u><a href="loginp.php" style="display: inline; color: #D1006C;" onmouseover="this.style.color='#D1006C'" onmouseout="this.style.color='#940A0A'">Login Here</a></u></div>
          </div>
