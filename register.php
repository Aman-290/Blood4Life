...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conn->prepare("INSERT INTO donor (name, email, phone, password, bloodgroup, gender, birthdate, `weight`, state, zipcode, district, area, landmark) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  if (!$stmt) {
      ...
      <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png'); margin: 0%;" aria-label="hero">
        ...
        <div class="container">
          <div class="form-container">
            <div class="form-title">Donor Register</div>
            ...
            <div class="form-title">Already Registered? <u><a href="login.php" style="display: inline; color: #D1006C;" onmouseover="this.style.color='#D1006C'" onmouseout="this.style.color='#940A0A'">Login Here</a></u></div>
