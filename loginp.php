            ...
            <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png'); margin: 0%;" aria-label="hero">
                ...
                <div class="container">
                    <div class="form-container">
                        ...
                        <div class="form-title">Not Registered? <u><a href="registerp.php" style="display: inline; color: #D1006C;" onmouseover="this.style.color='#D1006C'" onmouseout="this.style.color='#940A0A'">Register Here</a></u></div>
                    </div>
